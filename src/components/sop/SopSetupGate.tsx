    ...
    return (
        <div className="min-h-screen bg-zinc-50/60 pb-24">
            ...
            <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8 space-y-8">
                ...
                {validationError && (
                    <div className="p-4 bg-rose-50 border border-rose-200 rounded-2xl flex items-center gap-3 text-rose-800 text-sm font-medium animate-shake">
                ...
                {aiError && (
                    <div className="p-6 bg-amber-50/90 border border-amber-300 rounded-2xl space-y-4 shadow-sm">
                ...
                <section className="p-6 rounded-2xl bg-white border border-zinc-200/80 shadow-sm">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                placeholder="예: 김민지"
                                className="w-full px-3.5 py-2.5 bg-zinc-50 border border-zinc-300 rounded-xl text-sm font-semibold text-zinc-900 focus:bg-white focus:ring-2 focus:ring-indigo-500"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-3.5 py-2.5 bg-zinc-50 border border-zinc-300 rounded-xl text-sm font-medium text-zinc-900 focus:bg-white focus:ring-2 focus:ring-indigo-500"
                            />
                        </div>
                    </div>
                </section>
